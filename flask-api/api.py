...
labels = ["avocado", "broccoli", "carrot", "chicken breast", "corn", "egg", "lemon", "pork belly", "potato", "salmon", "tomato", "rice", "tofu", "apple", "banana", "green beans", "chicken thigh"]
 # Modify based on your labels
